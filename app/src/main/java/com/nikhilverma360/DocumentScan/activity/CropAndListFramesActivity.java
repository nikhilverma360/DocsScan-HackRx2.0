...
import com.nikhilverma360.DocumentScan.AsyncTask.ExportPdfTask;
import com.nikhilverma360.DocumentScan.DBHelper;
import com.nikhilverma360.DocumentScan.R;
import com.nikhilverma360.DocumentScan.Utils;
import com.nikhilverma360.DocumentScan.adapter.ProgressFramesAdapter;
import com.nikhilverma360.DocumentScan.data.BoundingRect;
import com.nikhilverma360.DocumentScan.data.Frame;
...
import static com.nikhilverma360.DocumentScan.Filter.auto;
import static com.nikhilverma360.DocumentScan.Utils.createPhotoFile;
import static com.nikhilverma360.DocumentScan.activity.CropActivity.getPerspectiveTransform;
...
public class CropAndListFramesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View finish = findViewById(R.id.savepdf);

        recyclerView.setLayoutManager(new GridLayoutManager(this, 2));
        recyclerView.setHasFixedSize(true);

        finish.setOnClickListener(view -> {
            Intent i = new Intent(CropAndListFramesActivity.this, KycActivity.class);
